    ...
    <div class="tab-pane fade show active" id="tabA">
        ...
        <tfoot class="table-secondary" >
          <tr>
            ...
            <td id="net_qty">0</td>
            <th>Rec Qty</th>
            <td id="net_rec_qty">0</td>
            <th>Rej Qty</th>
            <td id="net_rej_qty">0</td>
            <th>Gross Qty</th>
            <td id="net_gross_qty">0</td>
            <th>Net Qty</th>
            <td id="total_net_qty">0</td>
            <td></td>
          </tr>
        </tfoot>
      </table>
