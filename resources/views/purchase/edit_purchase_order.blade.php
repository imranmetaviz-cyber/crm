...
<form role="form" id="delete_form" method="POST" action="{{url('purchase/order/delete/'.$order['id'])}}">
    ...
    <div class="alert alert-success alert-dismissible">
     ...
     <div id="std_error" style="display: none;"><p class="text-danger" id="std_error_txt"></p></div>
      ...
      <!-- <div class="dropdown">
        <label>Vendor</label>
      <input class="form-control dropdown-toggle" id="vendor_name" type="text" data-toggle="dropdown" autocomplete="off" placeholder="Search vendor...." value="{{$order['vendor_name']}}" required  onchange="">
    ...
    <tbody id="vendor_tabel_body">
      ...
      <tr onclick="select_vendor('{{$vendor['name']}}','{{$vendor['id']}}' )">
        ...
        @endforeach
                  ...
                  <textarea name="vendor_address" id="vendor_address" class="form-control " >{{$order['vendor_address']}}</textarea>
                </div>

                <div class="form-group">
                  <label>Vendor Mobile</label>
                <input type="text" class="form-control " value="{{$order['vendor_phone']}}" name="vendor_phone" id="vendor_phone">
                </div>
       ...
       <div class="table-responsive">
        ...
        <tr ondblclick="(editItem('{{$rows}}'))" id="{{$rows}}">
          ...
          <td><input type="text"  id="{{'total_qty_'.$rows}}" form="purchase_order_form" name="total_qty[]" value="{{$item['total_qty']}}" readonly ></td>
           <td><input type="text" form="purchase_order_form" id="{{'current_rate_'.$rows}}" name="current_rate[]" value="{{$item['current_rate']}}" readonly ></td>
           <td><input type="text" form="purchase_order_form" id="{{'pack_rate_'.$rows}}" name="pack_rate[]" value="{{$item['pack_rate']}}" readonly ></td>
           <td><input type="text" form="purchase_order_form" id="{{'disc_'.$rows}}" name="disc[]" value="{{$item['discount']}}" readonly ></td>
  ...
  $.ajax({
     ...
     <td><input type="text" form="purchase_order_form" id="total_qty_${rows}" name="total_qty[]" value="${item['total_qty']}" readonly ></td>
       <td><input type="text" form="purchase_order_form" id="current_rate_${rows}" name="current_rate[]" value="" readonly ></td><td><input type="text" form="purchase_order_form" id="pack_rate_${rows}" name="pack_rate[]" value="" readonly ></td><td><input type="text" form="purchase_order_form" id="disc_${rows}" name="disc[]" value="" readonly ></td><td><input type="text" form="purchase_order_form" id="rate_${rows}" name="rate[]" value="" readonly ></td>
          ...
          <td><input type="text" form="purchase_order_form" id="tax_${rows}" name="tax[]" value="" readonly ></td><td></td>
