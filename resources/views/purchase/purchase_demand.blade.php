 ...
 -->
        ...
        <input class="form-control"  name="item_code" id="item_code">
              ...
              <div class="col-md-1">
                  ...
                  <input type="number" min="1" value="1" step="1"  form="add_item" name="p_s" id="p_s" value="1"  onchange="setTotalQty()" class="form-control select2" readonly required="true" style="width: 100%;">
                </div>
              </div>
     ...
     <div class="modal fade show" id="addItemModal"  aria-modal="true" role="dialog">
        <div class="modal-dialog modal-lg">
          ...
          <tbody id="productsTableBody">
            ...
            <tr data-id="{{$item['id']}}"  data-department="{{$item['department_id']}}" >
