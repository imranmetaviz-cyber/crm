   ...
   <div id="item_add_error" style="display: none;"><p class="text-danger" id="item_add_error_txt"></p></div>
        ...
        <tbody id="selectedItems">
          ...
          <tr ondblclick="(editItem('{{$rows}}'))" id="{{$rows}}"><td>
            ...
            <td><input type="text" form="purchase_order_form" id="{{'uom_'.$rows}}" name="" value="@if($item['item']['uom']!=''){{$item['item']['uom']['name']}}@endif" readonly ></td>
     <td><input type="text" form="purchase_order_form"  id="{{'unit_'.$rows}}" name="units[]" value="{{$item['unit']}}" readonly ></td><td><input type="text"  id="{{'qty_'.$rows}}" form="purchase_order_form" name="qtys[]" value="{{$item['quantity']}}" readonly ></td>
...
function loadGRN()
{
  ...
  $.ajax({
     ...
     var txt=`<tr ondblclick="(editItem(${rows}))" id="${rows}"><td><input type="hidden"  id="pivot_id_${rows}" name="pivot_ids[]" form="purchase_order_form" value="0"  ></td><td><input type="text"  id="location_${rows}" name="locations[]" form="purchase_order_form" value="${item['location']}" readonly ><input type="hidden"  id="location_id_${rows}" name="location_ids[]" form="purchase_order_form" value="${item['location_id']}"  ></td><td><input type="text" form="purchase_order_form"  id="code_${rows}" name="codes[]" value="${item['item_code']}" readonly ></td>
     ...
     <td><input type="text" form="purchase_order_form"  id="item_grn_${rows}" name="items_grn[]" form="purchase_order_form" value="${item['grn_no']}" readonly ><input type="hidden" form="purchase_order_form" name="items_stock[]"  value="${item['stock_id']}"</td>
