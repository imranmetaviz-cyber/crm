<html>
    ...
    <body>
        ...
        <tr style="background-color:#03a9f4;color: white;"><td style="padding: 10px;" class="top-heading" colspan="3"><strong>Goods Receipt Note</strong></td></tr>
        ...
        <tr class="">
            ...
            <td align=""  style="width: 40%;">
               ...
               <table class="challan-detail" >
                 <tr><th>Rec No:</th><td>{{$grn['grn_no']}}</td></tr>
                 <tr><th>Rec Date:</th><td>{{$grn['doc_date']}}</td></tr>
                 @if($grn['vendor']!='')<tr><th>Vendor:</th><td>{{$grn['vendor']['name']}}</td></tr>@endif
               </table>
    ...
    <div style="height:30px;background-color: #03a9f4;"></div>
     ...
     <?php 
           ...
           $qty=$item['pivot']['rec_quantity'] * $item['pivot']['pack_size'] ;
           $total += $qty;
          ?>
       <tr>
         <td class="col">{{$i}}</td>
         <td class="col" style="text-transform: capitalize;">{{$item['department']['name']}}</td>
         <td class="item-name-col">{{$item['item_name']}}</td>
         <td class="col">{{$item['pivot']['grn_no']}}</td>
         <td class="col">@if($item['unit']!=''){{$item['unit']['name']}}@endif</td>
         <td class="col">{{$qty}}</td>
