...
@section('title', 'Inventory Type Configuration')
@section('header-css')
...
<form role="form" method="post" action="{{url('configuration/inventory/type/save')}}">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="display: inline;">Inventory Type Configuration</h1>
      ...
      <div class="container-fluid" style="margin-top: 10px;">
         ...
         <div class="card">
              <div class="card-header">
                <h3 class="card-title">Inventory Type</h3>
        ...
        {{ session()->get('success') }}
             ...
             @endif
                ...
                <div class="row">
                   ...
                   <legend class="w-auto">Add New Inventory Type</legend>
