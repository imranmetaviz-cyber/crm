...
@section('title', 'Inventory Category Configuration')
@section('header-css')
...
<form role="form" method="post" action="{{url('configuration/inventory/category/save')}}">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="display: inline;">Inventory Category Configuration</h1>
        ...
        {{ session()->get('success') }}
             ...
             @endif
                ...
                <div class="row">
                   ...
                   <legend class="w-auto">Add New Inventory Category</legend>
