    ...
    <body>
        ...
        <tr>
            <td align="" style="width: 34%;">
                ...
                <p class="top-heading-address"><b>{{$address}}<br>{{'NTN No : 7240532-5'}}</b></p>
            </td>
            <td align="center" style="width: 33%">
                <p class="top-heading"><strong>SALE INVOICE</strong></p>
        ...
        <tr style="border-spacing: 0;">
            <td class="to" >
                ...
                <p class="address"><b>{{'NTN No.: '.$sale['customer']['ntn']}}</b></p>
            </td>
            <td class="from" >
                <p><b>FROM:</b></p>
    ...
    <div style="height:30px;background-color: #03a9f4;"></div>
     ...
     @foreach($items as $item)
       ...
       <tr>
         ...
         <td class="col bottom">{{$item['um']}}</td>
         ...
         <td class="col bottom">{{$item['discounted_rate']}}</td>
    ...
    <?php
     ...
     ?>
         <table style="float: right;margin:10px;" cellpadding="0" cellspacing="5">
            ...
            @if($sale['net_discount']!=0)
             <tr><th>Discount:</th><td>{{$sale['net_discount'].$type}}</td></tr>
             @endif
             <tr><th>GST Amount:</th><td>{{$sale['gst_amount']}}</td></tr>
             @foreach($sale['expenses'] as $exp)
             <tr><th>{{$exp['expense'].':'}}</th><td>{{$exp['amount']}}</td></tr>
              @endforeach
             <tr><td colspan="2"><hr></td></tr>
             <tr>
                <th>Net Amount:</th>
                <td>{{number_format($sale['net_bill'],2)}}</td>
             </tr>
         </table>
   </div>
