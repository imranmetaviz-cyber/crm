        ...
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb" class="mt-2">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active text-white" aria-current="page">Add New Delivery Challan</li>
                </ol>
            </nav>
        </div>
      </div>
...
@section('content')
 ...
 <form role="form" id="purchase_demand" method="POST" action="{{url('/delivery-challan/save')}}" onkeydown="return event.key != 'Enter';" >
            ...
            <div class="row">
              <div class="col-md-4">
                ...
                <div class="form-group row">
                  ...
                  <input type="date" form="purchase_demand" name="challan_date" class="form-control  col-sm-8" value="{{date('Y-m-d')}}" required style="width: 100%;">
                  </div>
                  ...
                  <input type="text" form="purchase_demand" name="bilty_no" class="form-control  col-sm-8"  style="width: 100%;">
                  </div>
    ...
    <div id="item_add_error" style="display: none;"><p class="text-danger" id="item_add_error_txt"></p></div>
             ...
             <div class="col-md-2">
              ...
              <div class="col-md-2">
                    <div class="form-group">
                  <label>Tax %</label>
                  <input type="number" min="0" step="any" form="add_item" name="tax" id="tax_0" class="form-control" onchange="setItemNet(0)"  style="width: 100%;">
                </div>
              </div>
              ...
              <div class="col-md-2">
                  ...
                  <input type="number" min="0" step="any" form="add_item" name="tax_amount" id="tax_amount_0" class="form-control" readonly style="width: 100%;">
                </div>
              </div>
              ...
              <div class="col-md-2">
                  ...
                  <input type="number"  min="0" step="any" form="add_item" name="net_amount" id="net_amount_0" class="form-control" readonly style="width: 100%;">
                </div>
              </div> -->
