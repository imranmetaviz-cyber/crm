        ...
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb" class="mt-2">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active text-white" aria-current="page">Add New Order</li>
                </ol>
            </nav>
        </div>
      </div>
...
<form role="form" id="purchase_demand" method="POST" action="{{url('/order/save')}}">
            ...
            <div class="row">
              <div class="col-md-3">
                ...
                <div class="form-group">
                  ...
                  <input type="date" form="purchase_demand" name="order_date" class="form-control select2" value="{{date('Y-m-d')}}" required style="width: 100%;">
                  </div>

                  <div class="form-group">
                  <label>PO No.</label>
                  <input type="text" form="purchase_demand" name="po_no" class="form-control" value=""  style="width: 100%;">
                  </div>


                <div class="form-group">
                  <label>PO Date</label>
                  <input type="date" form="purchase_demand" name="po_date" class="form-control" value="{{date('Y-m-d')}}"  style="width: 100%;">
                  </div>
    ...
    <div id="item_add_error" style="display: none;"><p class="text-danger" id="item_add_error_txt"></p></div>
        ...
        <input class="form-control"  name="item_code" id="item_code">
              ...
              <div class="col-md-1">
                    <div class="form-group">
                  <label>Qty</label>
                  <input type="number" value="1" min="1" form="add_item" name="qty" id="qty_0" onchange="setTotalQty(0)" class="form-control" required="true" style="width: 100%;">
                </div>
              </div>
              ...
              <div class="col-md-2">
                  ...
                  <input type="number" min="1" value="1" step="1"  form="add_item" name="p_s" id="p_s_0" value="1"  onchange="setTotalQty(0)" class="form-control" readonly required="true" style="width: 100%;">
                </div>
              </div>
